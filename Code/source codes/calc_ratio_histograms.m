function [gof,gaussfit,lnZ,all_red_selected,all_blue_selected,all_yellow_selected,y3,y4] = calc_ratio_histograms(all_blue,all_red,all_yellow,lnORnormal,normalisation,save_name,criterion)
