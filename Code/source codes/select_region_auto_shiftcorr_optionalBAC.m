function [r,b, r_start, r_end, c_start, c_end, start_point_cell,offset] = select_region_auto_shiftcorr_optionalBAC(i_red,i_blue,nImage,parameters,index)

global n

if (parameters.offsetcorr == 1 && ~isfield(parameters, 'offset'))
...
elseif parameters.offsetcorr == 1 && isfield(parameters, 'offset')
    
    offset = parameters.offset(n,:);
