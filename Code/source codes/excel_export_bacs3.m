function excel_export_bacs3(folders2analyse,all_blue_ampli_collected,all_red_ampli_collected,all_yellow_ampli_collected,lnZ_hist_counts,lnZ_hist_freq,save_name)
    ...
    for n5=1:length(folders2analyse)
        ...
        col = columns{count};
        xlswrite1(strcat(save_name,'results_all_datasets.xls'),folders2analyse(n5),'intensities',strcat(col,'1:',col,'1'))
        length_excelsheet = length(all_red_ampli_collected{n5});
        xlswrite1(strcat(save_name,'results_all_datasets.xls'),{'red intensities'},'intensities',strcat(col,'2:',col,'2'));
        xlswrite1(strcat(save_name,'results_all_datasets.xls'),all_red_ampli_collected{n5},'intensities',strcat(col,'3:',col,num2str(length_excelsheet)))
        
 
        col = columns{count+1};
        length_excelsheet = length(all_blue_ampli_collected{n5});
        xlswrite1(strcat(save_name,'results_all_datasets.xls'),{'green intensities'},'intensities',strcat(col,'2:',col,'2'));
        xlswrite1(strcat(save_name,'results_all_datasets.xls'),all_blue_ampli_collected{n5},'intensities',strcat(col,'3:',col,num2str(length_excelsheet)))
        
        
        col = columns{count+2};
        length_excelsheet = length(all_yellow_ampli_collected{n5});
        xlswrite1(strcat(save_name,'results_all_datasets.xls'),{'yellow intensities'},'intensities',strcat(col,'2:',col,'2'));
        xlswrite1(strcat(save_name,'results_all_datasets.xls'),all_yellow_ampli_collected{n5},'intensities',strcat(col,'3:',col,num2str(length_excelsheet)))
